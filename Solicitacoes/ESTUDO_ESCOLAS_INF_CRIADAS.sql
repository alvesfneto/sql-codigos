...
/* UNIDADES EMEI E CEU EMEI*/
	...
	LEFT JOIN (SELECT CD_UNIDADE_EDUCACAO,B.DRE
					  ...
					  JOIN Bd_Local_Aux..tbl_dre B ON A.cd_unidade_administrativa_portal=B.CODLOC COLLATE SQL_Latin1_General_CP1_CI_AI) D ON A.cd_escola=D.cd_unidade_educacao
