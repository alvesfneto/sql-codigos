--LISTA UNIDADES CIEJA, EMEBS E EMEFM COM QTDE DE ALUNOS POR FAIXAS ETÁRIAS

/*
A fim de oferecer informações atualizadas para o Núcleo de Transparência (NUTAC), 
no que diz respeito aos Grêmios Estudantis e o público contemplado com faixa 
etária entre 15 e 29 anos, solicitamos, por gentileza, os nomes das
 EMEFMs, EMEBSs, CIEJAs e EJAs, bem como o quantitativo de 
 estudantes correspondentes a cada ano/sério.
 */
SELECT
DRE,
B.CD_ESCOLA,
...
COUNT (DISTINCT CASE WHEN (C.IDADE BETWEEN 0 AND 14 AND A.SG_ETAPA IS NOT NULL) THEN A.CD_ALUNO ELSE NULL END) AS 'ATÉ 14 ANOS',
