...
--ENDEREÇO 1
DECLARE @END NVARCHAR(200) SET @END ='Rua das Palmeiras n.º 213'--FORNECER O ENDEREÇO
DECLARE @LAT_Y FLOAT SET @LAT_Y = -23.53743568869506	 		    --INFORMAR A LATITUDE DO ENDEREÇO(GOOGLE  MAPS)
DECLARE	@LON_X FLOAT SET @LON_X = -46.651348288603266             --INFORMAR A LONGITUDE DO ENDEREÇO(GOOGLE  MAPS)
...
WHERE B.CD_ESCOLA = '308354' -- INFORMAR O CD_ESCOLA DA UNIDADE DE MATRICULA DOS ALUNOS
--AND 
