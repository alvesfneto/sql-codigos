/*
Lista de escolas com informações de matriculas por turnos
*/

DROP TABLE ##MATRICULAS_POR_TURNO
SELECT 
A.AN_LETIVO,
...
C.NR_SALA,
C.dc_tipo_turno,
COUNT (A.CD_ALUNO) AS MATR,
CONVERT(VARCHAR,A.CRDATE-1,103) AS DT_BASE
INTO ##MATRICULAS_POR_TURNO
...
WHERE B.TP_ESCOLA IN (1,2,3,4,10,11,12,13,16,17,18,22,28,30,31) --AND COUNT(A.DEF1)<>0
GROUP BY
B.DRE,B.CD_ESCOLA,B.SG_TP_ESCOLA, B.NOMESC,
C.CD_TURMA_ESCOLA,
C.DC_TIPO_AMBIENTE,
...
A.CRDATE,
A.AN_LETIVO
--SELECT * FROM ##MATRICULAS_POR_TURNO
