...
*/
DROP TABLE ##ALUNOS_ATE_1500M_DomingosRinaldelli
SELECT DISTINCT
A.DRE,
A.CD_ESCOLA,
A.SG_TP_ESCOLA,
...
INTO ##ALUNOS_ATE_1500M_DomingosRinaldelli
...
AND FLOOR(FLOOR(SQRT(POWER((LAT_ALUNO * 1000000 - (-23.743322326363707 * 1000000) ),2) +  
				 POWER((LON_ALUNO * 1000000 - (-46.68336586098009 * 1000000)),2)) / 10)/0.6)<=1500

--SELECT * FROM ##ALUNOS_ATE_1500M_DomingosRinaldelli

--SELECT TOP 10 * FROM VW_ENDERECOS_ALUNOS_COM_RESPONSAVEIS